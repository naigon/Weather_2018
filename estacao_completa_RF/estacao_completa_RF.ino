//Nelson Weather
//Estação completa com todos os sensores e transmissao via RF 315 MHz
...
void setup(){
  ...
  //Define o pino 9 do Arduino como 
...
void loop(){
  ...
  data.humidity = humid;
  data.rain = rain_count;
  data.wind = vel_vento;
  data.luminosity = luminosidade;

  vw_send((uint8_t *)&data, sizeof(data));//envia dados via RF
